...
export const googlePlacesApiKey = 'AIzaSyAAuJJI9BKINNLj1ekKfll5akpzWyoWALg';


// https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyAAuJJI9BKINNLj1ekKfll5akpzWyoWALg
// ffc_the:Champions2019
